#!/usr/bin/env python3
"""
Script d'entraînement YOLO pour la détection de l'ouverture du sachet.

Usage:
    python scripts/train_bag_opening.py
    python scripts/train_bag_opening.py --resume
    python scripts/train_bag_opening.py --epochs 300 --batch 64 --imgsz 640
"""
...
# Modèle de base (pré-entraîné, détection)
MODEL = "yolo26n.pt"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train YOLO bag_opening model")
