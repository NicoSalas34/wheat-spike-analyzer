...
Usage:
    python scripts/train_obb_angled.py
    python scripts/train_obb_angled.py --resume
    python scripts/train_obb_angled.py --epochs 300 --batch 8 --imgsz 640
"""
...
# Dataset
DATA = "trainings/training_obb_angled/data.yaml"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train YOLO-Seg rachis model")
