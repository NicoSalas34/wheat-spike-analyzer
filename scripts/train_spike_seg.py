...
Usage:
    python scripts/train_spike_seg.py
    python scripts/train_spike_seg.py --resume
    python scripts/train_spike_seg.py --epochs 300 --batch 8 --imgsz 640
"""
...
# Dataset
DATA = "trainings/training_spike_segmentation/data.yaml"
